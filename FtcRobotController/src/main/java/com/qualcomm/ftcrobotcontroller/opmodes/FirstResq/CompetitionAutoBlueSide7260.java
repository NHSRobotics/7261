 ...
 */
public class CompetitionAutoBlueSide7260 extends OpMode{
    ...
    public void loop(){
        ...
        switch (state){
            ...
            case 1:
                ...
                //
                counts = ENCODER_CPR * (39 / (Math.PI * wheelDiameter)) * gearRatio;
            ...
            case 5:
                ...
                counts = ENCODER_CPR * (56 / (Math.PI * wheelDiameter)) * gearRatio;
            ...
            case 7:
                ...
                counts = ENCODER_CPR * (12 / (Math.PI * wheelDiameter)) * gearRatio;
            ...
            //Resets the count to zero
            //
            //Sets the target angle to 135 clockwise
            //
            case 19:
                if(Chassis.leftMotor.getCurrentPosition() == 0 && Chassis.rightMotor.getCurrentPosition() == 0){
                    resetStartTime();
