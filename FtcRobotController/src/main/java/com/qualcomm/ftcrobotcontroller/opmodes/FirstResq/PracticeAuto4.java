 ...
 */
public class PracticeAuto4 extends OpMode{
    ...
    public void loop(){
        switch (state){
            ...
            case 3:
                ...
                angleCorrection = -45 - angleCalibrate;

                if (gyro.getIntegratedZValue() <= (angleCorrection)){
                    Chassis.leftMotor.setPower(0);
                    Chassis.rightMotor.setPower(0);
            ...
            case 7:
                ...
                angleCorrection = -90 + (angleCalibrate + 45);
