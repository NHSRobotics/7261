...
/**
 * Autonomous program that runs to bucket on the red-side, drops the climbers into the bucket, and lights the beacon
 */
public class CompetitionAutoRedSide7261 extends OpMode{
    ...
    AdafruitI2cColorSensor RGBSensor;       //Adafruit color sensor class
    ...
    boolean gyro1st = true;                  //Holds if the if the first gyro calibration has occurred
    ...
    public void loop(){
        ...
        switch (state) {
            ...
            case 5:
                ...
                counts = ENCODER_CPR * (82 / (Math.PI * wheelDiameter)) * gearRatio;
            ...
            case 25:
                ...
                counts = ENCODER_CPR * (1 / (Math.PI * wheelDiameter)) * gearRatio;
...
*/
        ...
        colorCounts = redCount + blueCount;
        telemetry.addData("Color Counts:", colorCounts);
